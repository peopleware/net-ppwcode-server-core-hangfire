...
:github: https://github.com/peopleware/net-ppwcode-server-core-hangfire/releases/tag/
:nuget: https://www.nuget.org/packages/PPWCode.Server.Core.Hangfire/
:ppwcode-docs: https://peopleware.github.io/net-ppwcode-docs/ppwcode-server-core-hangfire/
